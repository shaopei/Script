...
tss_plus_f=/workdir/sc2457/mouse_AlleleSpecific/LEP_ZYG_ATGCA.dREG/tss_paired_LEP_ZYG_ATGCA_dREG_plus.bed
tss_minus_f=/workdir/sc2457/mouse_AlleleSpecific/LEP_ZYG_ATGCA.dREG/tss_paired_LEP_ZYG_ATGCA_dREG_minus.bed
...
new_name=LEP_ZYG_ATGCA_d${d}_dRegion${dRegion}_withStrandSpecific_MinCount${Min_count}_MaxPvalue${Max_Pvalus}.txt
